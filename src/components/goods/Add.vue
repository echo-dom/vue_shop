<template>
    ...
    <el-tab-pane label="基本信息" name="0">
        ...
        <el-form-item label="商品分类" prop="goods_cat">
            <el-cascader  expand-trigger="hover"
                ...
                :options="catalist"
                :props="cateProps"
                @change="handleChanged" clearable ></el-cascader>
        </el-form-item>
    </el-tab-pane>
  ...
  width="50%">
  <img :src="prePath" alt="" class="previewImg">
</el-dialog>
  </div>
</template>
...
export default {
  data () {
    return {
      ...
      addFormRules: {
        ...
        goods_number: [{ required: true,message: '请输入商品数量',trigger: 'blur' },{ required: true,message: '请输入商品分类',trigger: 'blur' }
        ]
      },
      //   商品分类数据
      catalist: [],
  ...
  methods: {
    ...
    handleRemove (file) {
      ...
      // 3.调用数组splice方法，把图片的信息对象，从pics数组中移除
